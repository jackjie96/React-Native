...
/* components */
import { ScreenHeader, LoadingSquare } from '../components/index';
...
class MainScreen extends React.Component {
  ...
  renderSearchBtn = () => (
    <TouchableOpacity
      ...
      onPress={() => this.props.navigation.navigate('SearchRepoScreen')}>
  ...
  render() {
    return (
      <View style={{ flex: 1 }}>
        ...
        {this.props.repository.isLoading ? <LoadingSquare /> : null}
